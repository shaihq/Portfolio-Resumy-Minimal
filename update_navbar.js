...
// Add Menu icon to lucide-react import
content = content.replace('import { ChartSpline, Eye, PaintRoller, Check } from "lucide-react";', 'import { ChartSpline, Eye, PaintRoller, Check, Menu } from "lucide-react";');

const oldNav = `        <nav className="bg-white dark:bg-[#2A2520] border border-black/8 dark:border-white/10 rounded-full shadow-sm pointer-events-auto max-w-[640px] w-full">
...
const newNav = `        <nav className="bg-white dark:bg-[#2A2520] border border-black/8 dark:border-white/10 rounded-full shadow-sm pointer-events-auto max-w-[640px] w-full">
          <div className="px-2 md:px-2 py-2 flex items-center justify-between gap-4 md:gap-8">
          {/* Logo */}
          <div className="flex items-center gap-3">
            <svg width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
              <rect width="37" height="37" rx="18.5" fill="#FF553E"/>
              <path d="M20.0417 4.625H16.9583V14.7781L9.77902 7.59877L7.59877 9.77902L14.7781 16.9583H4.625V20.0417H14.7781L7.59877 27.221L9.77902 29.4012L16.9583 22.2219V32.375H20.0417V22.2219L27.221 29.4012L29.4012 27.221L22.2219 20.0417H32.375V16.9583H22.2219L29.4012 9.77902L27.221 7.59877L20.0417 14.7781V4.625Z" fill="white"/>
            </svg>
            ...
            <Sheet>
              ...
              <SheetContent side="bottom" className="rounded-t-3xl bg-white dark:bg-[#2A2520] border-t border-black/10 dark:border-white/10 p-6 flex flex-col gap-6">
                <div className="flex flex-col gap-4">
                  ...
                  <Button 
                    variant="ghost" 
                    className="w-full justify-start text-[#7A736C] dark:text-[#9E9893] hover:text-[#1A1A1A] dark:hover:text-[#F0EDE7] hover:bg-[#F5F5F5] dark:hover:bg-[#3A3531]"
                  ...
                  <Button 
                    className="w-full bg-black hover:bg-[#2A2A2A] dark:bg-white dark:hover:bg-[#E8E8E8] text-white dark:text-black font-medium"
                  >
                    Publish
                  </Button>
                </div>
