...
export function FloatingNav() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[72px] z-[200] flex flex-col items-center bg-secondary dark:bg-card border-r border-black/[0.06] dark:border-white/[0.06]">
      {/* Logo */}
