...
export function FloatingNav() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[72px] z-[200] flex flex-col items-center bg-secondary dark:bg-[hsl(20,12%,6%)] border-r border-black/[0.06] dark:border-white/[0.04]">
      {/* Logo */}
