            ...
            <div className="mt-5 space-y-3.5">
              ...
              <div className="space-y-1.5">
                ...
                <button className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-foreground/[0.03] hover:bg-foreground/[0.06] border border-black/[0.05] dark:border-white/[0.05] transition-colors group text-left">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[12px] font-medium text-foreground/65 group-hover:text-foreground/85 transition-colors leading-none">Tailor resume to this role</div>
                    <div className="text-[10.5px] text-foreground/35 mt-0.5 leading-snug">Rewritten to match what they're hiring for</div>
                  </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[12px] font-medium text-foreground/65 group-hover:text-foreground/85 transition-colors leading-none">Practice with a mock interview</div>
                    <div className="text-[10.5px] text-foreground/35 mt-0.5 leading-snug">
                ...
                <button className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-foreground/[0.03] hover:bg-foreground/[0.06] border border-black/[0.05] dark:border-white/[0.05] transition-colors group text-left">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[12px] font-medium text-foreground/65 group-hover:text-foreground/85 transition-colors leading-none">Write a job-specific cover letter</div>
                    <div className="text-[10.5px] text-foreground/35 mt-0.5 leading-snug">Drafted in your voice, shaped to this role</div>
                  </div>
                  <ChevronRight className="w-3.5 h-3.5 text-foreground/20 group-hover:text-foreground/45 transition-colors flex-shrink-0" />
                </button>
                ...
                <button className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-foreground/[0.03] hover:bg-foreground/[0.06] border border-black/[0.05] dark:border-white/[0.05] transition-colors group text-left">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[12px] font-medium text-foreground/65 group-hover:text-foreground/85 transition-colors leading-none">Run a deep fit analysis</div>
                    <div className="text-[10.5px] text-foreground/35 mt-0.5 leading-snug">See what lands and what's holding you back</div>
                  </div>
                  <ChevronRight className="w-3.5 h-3.5 text-foreground/20 group-hover:text-foreground/45 transition-colors flex-shrink-0" />
                </button>
              </div>
