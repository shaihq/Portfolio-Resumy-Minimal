...
import { PasswordProtectDropdown } from "@/components/ui/password-protect-dropdown";
              ...
              <div className="relative z-10 flex justify-center pt-7 pointer-events-none">
                <div className="w-full max-w-[1100px] px-6 md:px-12 flex items-center justify-between pointer-events-auto">
                  ...
                  <div className="flex items-center gap-5">
                    <PasswordProtectDropdown
                      isOpen={isPasswordOpen}
                      onToggle={() => setIsPasswordOpen(v => !v)}
                      triggerClassName="flex items-center gap-1.5 text-[13px] font-medium text-white/80 hover:text-white transition-colors bg-white/10 hover:bg-white/15 backdrop-blur-sm px-3.5 py-1.5 rounded-full"
                      triggerContent={<><Lock size={12} strokeWidth={2.5} />Password Protect</>}
                    />
              ...
              <div className="w-full max-w-[880px] px-6 md:px-10 flex items-center justify-between py-4">
                ...
                <div className="flex items-center gap-5">
                  <PasswordProtectDropdown
                    isOpen={isPasswordOpen}
                    onToggle={() => setIsPasswordOpen(v => !v)}
                    triggerClassName="flex items-center gap-1.5 text-[13px] font-medium text-[#7A736C] dark:text-[#9E9893] hover:text-[#1A1A1A] dark:hover:text-[#F0EDE7] transition-colors bg-black/5 dark:bg-white/5 hover:bg-black/8 dark:hover:bg-white/8 px-3.5 py-1.5 rounded-full"
                    triggerContent={<><Lock size={12} strokeWidth={2.5} />Password Protect</>}
                  />
