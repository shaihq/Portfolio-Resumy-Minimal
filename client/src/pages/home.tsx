...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (isProjectsRearrangeOpen) {
      window.dispatchEvent(new CustomEvent('panelOpened', { detail: 'projectsrearrange' }));
    }
  ...
  useEffect(() => {
    ...
    if (activeTemplate === "Designer") {
      root.style.setProperty("--page-bg", "#F8FDFF");
      root.style.setProperty("--background", "198 100% 99%");
    } else {
  ...
  useEffect(() => {
    if (activeTemplate === "Chatfolio") {
      ...
      const timer13 = setTimeout(() => setChatRevealStep(13), 12500); // Message 11 - You: Testimonials prompt
      const timer14 = setTimeout(() => setChatRevealStep(14), 13500); // Message 12 - Testimonials intro
    ...
    <>
      ...
      >
        ...
        {activeTemplate === "Designer" && (
          <div className="absolute top-0 left-0 right-0 z-0 overflow-hidden" style={{ height: '100vh' }}>
            ...
            <div className="absolute bottom-0 left-0 right-0" style={{ height: 220, background: 'linear-gradient(to bottom, transparent 0%, #F8FDFF 100%)' }} />
          </div>
        )}
      ...
      {activeTemplate === "Minimal" && (
            ...
            <AnimatePresence>
              {(showHandles || isResizing) && (
                ...
                >
                  <div
                    className={cn(
                      "h-full rounded-full flex flex-col items-center justify-center gap-[5px] transition-all duration-200 border border-white/[0.15]",
                      isResizing
        ...
        {activeTemplate === "Minimal" ? (
          <>
            {/* Header Section */}
            <motion.div variants={sectionVariants} className="px-6 md:px-10 pt-8 pb-8 relative group/section bg-white/83 dark:bg-[#1A1A1A]/75 backdrop-blur-md rounded-t-2xl">
          {isEditing && (
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 sm:gap-0">
            <div>
              <h1 className={`${typographySize === "expressive" ? "text-[34px]" : "text-[30px]"} font-semibold mb-0.5 tracking-[-0.01em] text-[#1A1A1A] dark:text-[#F0EDE7]`}>
                <motion.span
                  initial="hidden"
                  animate="visible"
              ...
              <p className={`text-[#4A4440] dark:text-[#C8C0B5] ${typographySize === "expressive" ? "text-[19px]" : "text-[17px]"}`} style={{ fontWeight: 500 }}>Product Designer</p>
            </div>
            <a 
              href="#" 
              className={`${typographySize === "expressive" ? "text-[14px]" : "text-[13px]"} font-medium flex items-center gap-1.5 border-b border-[#1A1A1A] dark:border-[#F0EDE7] pb-0.5 hover:opacity-70 transition-opacity w-fit group/download text-[#1A1A1A] dark:text-[#F0EDE7]`}
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-5 flex justify-between items-center relative group/section">
          ...
          <a 
            ...
            className={`flex items-center gap-2 ${typographySize === "expressive" ? "text-[17px]" : "text-base"} text-[#666666] dark:text-[#9E9893] hover:text-[#1A1A1A] dark:hover:text-[#F0EDE7] transition-colors group`}
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 relative group/section">
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-5`}>Intro</h2>
          <p className={`text-[#7A736C] dark:text-[#B5AFA5] leading-[1.7] ${typographySize === "expressive" ? "text-[18px]" : "text-[17px]"}`} style={{ fontWeight: 450 }}>
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 relative group/section">
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-5`}>Experience</h2>
            ...
            {experiences.map((exp, index) => (
              <div key={index} className="rounded-lg transition-colors hover:bg-black/[0.03] dark:hover:bg-white/[0.05] -mx-3 px-3 relative group/item">
                ...
                <button 
                  ...
                  className={`w-full flex justify-between items-center py-2.5 ${typographySize === "expressive" ? "text-[17px]" : "text-base"} group`}
                >
                  ...
                  <span className={`text-[#1A1A1A] dark:text-[#F0EDE7] font-medium group-hover:opacity-70 transition-opacity ${typographySize === "expressive" ? "text-[17px]" : "text-base"}`}>{exp.role}</span>
                </button>
                <AnimatePresence>
                  {expandedIndex === index && (
                    <motion.div
                    ...
                    >
                      <div className="pb-4 pl-7 pr-4">
                        <motion.p
                          ...
                          initial="hidden"
                          animate="show"
                          className={`text-[#7A736C] dark:text-[#B5AFA5] ${typographySize === "expressive" ? "text-[18px]" : "text-[17px]"} leading-[1.7] break-words whitespace-normal`}
                        >
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 pb-20 relative group/section">
          {isEditing && (
            <div className={`absolute top-4 right-4 z-10 transition-opacity flex gap-2 ${isProjectsAddDropdownOpen ? 'opacity-100' : 'opacity-100 md:opacity-0 md:group-hover/section:opacity-100'}`}>
              ...
              <DropdownMenu open={isProjectsAddDropdownOpen} onOpenChange={setIsProjectsAddDropdownOpen}>
                ...
                <DropdownMenuContent align="end" className="w-48 bg-white dark:bg-[#2A2520] border border-black/10 dark:border-white/10 shadow-lg rounded-xl overflow-hidden p-1">
                  <DropdownMenuItem 
              ...
              <Sheet modal={false} open={isProjectsPanelOpen} onOpenChange={setIsProjectsPanelOpen}>
                <SheetContent 
                  className="border-l border-black/10 dark:border-white/10 bg-white dark:bg-[#2A2520] p-0 flex flex-col"
                  hasOverlay={false}
                  onInteractOutside={(e) => {
                ...
                >
                  <SheetHeader className="px-5 py-4 border-b border-black/10 dark:border-white/10 flex-shrink-0 flex flex-row items-center m-0 space-y-0 h-[65px]">
                    <SheetTitle className="text-[#1A1A1A] dark:text-[#F0EDE7] text-[15px] font-medium m-0">Add Project</SheetTitle>
                  </SheetHeader>
                  
                  <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        <Label htmlFor="proj-title" className="text-[13px] font-medium text-[#1A1A1A] dark:text-[#F0EDE7] ml-1">Project Title</Label>
                        <Input id="proj-title" placeholder="e.g. Slate" className="h-10 bg-black/[0.03] dark:bg-white/[0.03] border-transparent rounded-xl text-[14px] text-[#1A1A1A] dark:text-[#F0EDE7] focus-visible:bg-transparent focus-visible:ring-2 focus-visible:ring-black/10 dark:focus-visible:ring-white/10 focus-visible:border-black/20 dark:focus-visible:border-white/20 transition-all px-3.5 shadow-none placeholder:text-black/30 dark:placeholder:text-white/30" />
                      </div>
                      <div className="space-y-1.5">
                        <Label htmlFor="proj-desc" className="text-[13px] font-medium text-[#1A1A1A] dark:text-[#F0EDE7] ml-1">Description</Label>
                        <textarea 
                          id="proj-desc" 
                          rows={3}
                      ...
                      <div className="space-y-1.5">
                        <Label className="text-[13px] font-medium text-[#1A1A1A] dark:text-[#F0EDE7] ml-1">Cover Image</Label>
                  ...
                  <div className="p-5 border-t border-black/10 dark:border-white/10 flex justify-end gap-3 flex-shrink-0 bg-white dark:bg-[#2A2520]">
                    ...
                    <SheetClose asChild>
                      <Button className="h-9 px-5 rounded-full text-[13px] font-medium bg-[#1A1A1A] dark:bg-white text-white dark:text-black hover:bg-black/80 dark:hover:bg-white/90 transition-colors shadow-sm">Add Project</Button>
                    </SheetClose>
                  </div>
                </SheetContent>
              </Sheet>
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-5`}>Projects</h2>
              ...
              <div className={`grid gap-x-5 gap-y-8 ${projectsLayout === 'grid' ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-1'}`}>
                {projects.map((project) => (
                  <div key={project.id} onClick={() => handleProjectClick(project.slug)} className="group cursor-pointer flex flex-col p-4 -m-4 rounded-2xl hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-all duration-300 relative">
                    ...
                    <h3 className={`font-semibold ${typographySize === "expressive" ? "text-[18px]" : "text-[17px]"} mb-1.5 text-[#1A1A1A] dark:text-[#F0EDE7]`}>{project.title}</h3>
                    <p className={`${typographySize === "expressive" ? "text-[16px]" : "text-[15px]"} text-[#7A736C] dark:text-[#B5AFA5] leading-relaxed`} style={{ fontWeight: 450 }}>
                      {project.description}
                    </p>
                  </div>
                ))}
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 relative group/section">
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-6`}>Recommendations</h2>
          ...
          {recommendations.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center rounded-2xl border border-dashed border-black/10 dark:border-white/10 bg-white/50 dark:bg-[#2A2520]/50 backdrop-blur-sm">
              ...
              <p className="text-[13px] text-[#7A736C] dark:text-[#9E9893] max-w-[250px] mb-5">Add recommendations to build trust and credibility.</p>
              {isEditing && (
                <Button 
                ...
                <div key={rec.id} className="bg-white dark:bg-[#2A2520] rounded-[16px] border border-black/5 dark:border-white/10 drop-shadow-sm overflow-hidden group/card relative">
                    ...
                    <div className="absolute top-3 right-3 z-20 transition-opacity flex gap-2 opacity-100 md:opacity-0 md:group-hover/card:opacity-100">
                      ...
                      <div onClick={(e) => e.stopPropagation()}>
                        <AlertDialog>
                          ...
                          <AlertDialogContent onClick={(e) => e.stopPropagation()} className="bg-[#F0EDE7] dark:bg-[#1A1A1A] border-black/10 dark:border-white/10 rounded-2xl p-6 gap-6 max-w-md w-[90vw]">
                            <AlertDialogHeader>
                              <AlertDialogTitle className="text-xl font-semibold text-[#1A1A1A] dark:text-[#F0EDE7]">Delete Recommendation</AlertDialogTitle>
                              <AlertDialogDescription className="text-[15px] text-[#7A736C] dark:text-[#B5AFA5]">
                  ...
                  <div className="flex justify-between items-center px-6 py-4">
                    <div className="flex flex-col">
                      <h3 className={`font-medium ${typographySize === "expressive" ? "text-[17px]" : "text-base"} text-[#1A1A1A] dark:text-[#F0EDE7] mb-1`}>{rec.name}</h3>
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`${typographySize === "expressive" ? "text-[14px]" : "text-[13px]"} text-[#7A736C] dark:text-[#9E9893]`}>{rec.role}</span>
                      </div>
                    </div>
                  ...
                  <div className="p-0">
                    <div className="border border-dashed border-[#E5D7C4] dark:border-[#3A352E] rounded-[12px] p-4">
                      <p className={`text-[#7A736C] dark:text-[#B5AFA5] ${typographySize === "expressive" ? "text-[18px]" : "text-[17px]"} leading-[1.7]`} style={{ fontWeight: 450 }}>
                        {rec.content}
                      </p>
                    </div>
                  </div>
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 pb-20 relative group/section">
          {isEditing && (
            <div className="absolute top-4 right-4 transition-opacity z-10 opacity-100 md:opacity-0 md:group-hover/section:opacity-100">
              <Sheet modal={false} open={isMyStoryPanelOpen} onOpenChange={setIsMyStoryPanelOpen}>
                ...
                >
                  <SheetHeader className="px-5 py-4 border-b border-black/10 dark:border-white/10 flex-shrink-0 flex flex-row items-center m-0 space-y-0 h-[65px]">
                    <SheetTitle className="text-[#1A1A1A] dark:text-[#F0EDE7] text-[15px] font-medium m-0">Edit My Story</SheetTitle>
                  </SheetHeader>
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-6`}>My Story</h2>
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 relative group/section">
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-6`}>Stack</h2>
        ...
        <motion.div variants={sectionVariants} className="px-6 md:px-10 py-10 relative group/section">
          ...
          <h2 className={`${typographySize === "expressive" ? "text-[15px]" : "text-[14px]"} font-bold text-[#463B34] dark:text-[#D4C9BC] font-['DM_Mono'] uppercase tracking-wider mb-8`}>Contact</h2>
          <div className="font-['DM_Mono'] grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5">
                  <span className={`text-[#463B34] dark:text-[#C4B5A0] ${typographySize === "expressive" ? "text-[14px]" : "text-[13px]"}`}>&#62;</span>
                  <span className={`${typographySize === "expressive" ? "text-[12px]" : "text-[11px]"} uppercase tracking-widest text-[#7A736C] dark:text-[#9E9893]`}>email</span>
                </div>
                <button
                  onClick={() => handleCopy("matt@gmail.com", "email")}
                  className="group flex items-center gap-2.5 ml-4"
                >
                  <span className={`${typographySize === "expressive" ? "text-[18px]" : "text-[17px]"} text-[#1A1A1A]/80 dark:text-[#F0EDE7]/80 border-b border-dashed border-[#1A1A1A]/15 dark:border-[#F0EDE7]/15 group-hover:border-solid group-hover:border-[#463B34]/50 dark:group-hover:border-[#C4B5A0]/50 transition-all duration-200 pb-px leading-snug`}>matt@gmail.com</span>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5">
                  <span className={`text-[#463B34] dark:text-[#C4B5A0] ${typographySize === "expressive" ? "text-[14px]" : "text-[13px]"}`}>&#62;</span>
                  <span className={`${typographySize === "expressive" ? "text-[12px]" : "text-[11px]"} uppercase tracking-widest text-[#7A736C] dark:text-[#9E9893]`}>phone</span>
                </div>
                <button
                  onClick={() => handleCopy("+91 98765 43210", "phone")}
                  className="group flex items-center gap-2.5 ml-4"
                >
                  <span className={`${typographySize === "expressive" ? "text-[16px]" : "text-[15px]"} text-[#1A1A1A]/80 dark:text-[#F0EDE7]/80 border-b border-dashed border-[#1A1A1A]/15 dark:border-[#F0EDE7]/15 group-hover:border-solid group-hover:border-[#463B34]/50 dark:group-hover:border-[#C4B5A0]/50 transition-all duration-200 pb-px leading-snug`}>+91 98765 43210</span>
                  <span className="text-[10px] uppercase tracking-widest transition-all duration-150 opacity-0 group-hover:opacity-100">
                    {copiedItem === "phone"
                      ? <span className="text-[#463B34] dark:text-[#C4B5A0]">copied</span>
                      : <span className="text-[#7A736C] dark:text-[#9E9893]">copy</span>
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1.5 mb-2">
                <span className={`text-[#463B34] dark:text-[#C4B5A0] ${typographySize === "expressive" ? "text-[14px]" : "text-[13px]"}`}>&#62;</span>
                <span className={`${typographySize === "expressive" ? "text-[12px]" : "text-[11px]"} uppercase tracking-widest text-[#7A736C] dark:text-[#9E9893]`}>links</span>
              </div>
          ...
          <div className="w-full flex-1 flex flex-col gap-3 pb-20 pt-0 px-4 md:px-0 max-w-[800px] mx-auto">
            ...
            >
              ...
              <div
                ...
                style={{ boxShadow: isDark ? "inset 0 1px 3px rgba(0,0,0,0.15)" : "inset 0 1px 3px rgba(0,0,0,0.04), inset 0 -1px 1px rgba(255,255,255,0.45)" }}
              >
                        ...
                        <div className="flex items-center gap-5">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              <a href="#" className="text-[#0077b5] opacity-60 hover:opacity-100 transition-opacity" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="bg-[#E5E2DB] dark:bg-[#2A2520] p-4 rounded-2xl rounded-tl-sm rounded-bl-sm transition-colors duration-700 border border-black/5 dark:border-white/5 w-full">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-10 h-10 rounded-full overflow-hidden shrink-0">
                          <img src="/testimonials/jonathan.jpg" alt="Jonathan Carter" className="w-full h-full object-cover bg-gray-200 dark:bg-gray-800" onError={(e) => { e.currentTarget.src = "https://i.pravatar.cc/150?u=a042581f4e29026704d" }} />
                        </div>
                        <div className="flex flex-col">
                          <span className="text-[#1A1A1A] dark:text-[#F0EDE7] font-medium text-[15px]">Jonathan Carter</span>
                          <div className="flex items-center gap-1.5">
                            <svg className="w-3.5 h-3.5 text-[#0077b5]" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                            </svg>
                            <span className="text-[#7A736C] dark:text-[#B5AFA5] text-[13px]">TechStarter CTO</span>
                          </div>
                        </div>
                      </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="px-6 md:px-0 pt-32 pb-10">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[18px] font-bold tracking-[0.04em] text-[#439BEA] dark:text-[#439BEA] font-['Caveat']">
                  Work experience
                </span>
