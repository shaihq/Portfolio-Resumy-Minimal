    ...
    <>
      ...
      {activeTemplate === "Minimal" && (
        ...
        {activeTemplate === "Minimal" ? (
          <>
            {/* Header Section */}
            <motion.div variants={sectionVariants} className="px-6 md:px-10 pt-8 pb-8 relative group/section bg-white/75 dark:bg-[#1A1A1A]/75 backdrop-blur-md rounded-t-2xl">
          {isEditing && (
