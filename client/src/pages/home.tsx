...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (activeTemplate === "Designer") {
      root.style.setProperty("--page-bg", "#F0EDE7");
      root.style.setProperty("--background", "36 18% 93%");
    } else {
      ...
      >
        ...
        {activeTemplate === "Designer" && (
          <div className="absolute top-0 left-0 right-0 z-0 overflow-hidden" style={{ height: '100vh' }}>
            ...
            <div className="absolute bottom-0 left-0 right-0" style={{ height: 220, background: 'linear-gradient(to bottom, transparent 0%, #F0EDE7 100%)' }} />
          </div>
        )}
