      ...
      <div className={cn("w-full max-w-[640px] relative min-h-screen flex flex-col font-['Inter'] transition-colors duration-700", 
        ...
        <motion.div variants={itemVariants} className="relative flex flex-col items-center justify-center overflow-hidden border-b border-[#E5D7C4]/50">
          ...
          <div className="w-full flex-1 flex flex-col gap-4 pb-20 pt-0 px-0 md:px-0 max-w-4xl mx-auto">
            ...
            {/* Marquee Tags */}
            <div className="bg-white/80 dark:bg-[#2A2520]/80 backdrop-blur-md rounded-[24px] border border-[#E5D7C4] dark:border-white/10 py-4 overflow-hidden relative w-full">
