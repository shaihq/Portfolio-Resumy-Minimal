...
function BuiltForTypewriter() {
  ...
  return (
    <div className="inline-flex items-center gap-[0.5em] whitespace-nowrap">
      ...
      <span className="text-[#1D1B1A]/70 dark:text-foreground/60 font-semibold">BUILT FOR</span>
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="flex flex-col min-w-0 gap-0.5">
            ...
            <span className="text-[11.5px] text-[#1D1B1A]/70 dark:text-foreground/60 leading-tight truncate">{t.role}</span>
          </div>
        </div>
        {t.logoSrc && (
            ...
            <div className="flex items-center justify-between gap-3 mb-3.5">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <div className="text-[13px] font-medium text-[#1D1B1A]/70 dark:text-foreground/60 leading-tight">{testimonials[currentIndex].role}</div>
                </div>
              </div>
      ...
      <div className="w-full max-w-[792px] bg-[#FFFEF2] dark:bg-background min-h-screen border-x border-[#EAE9E4] dark:border-border relative z-10 shadow-[0_0_40px_rgba(0,0,0,0.02)]">
        ...
        <div className="hidden lg:block absolute right-full top-0 bottom-0 z-40">
          <div className="sticky top-[120px] flex flex-col items-start pr-12 w-max">
            ...
            >
              ...
              <nav className="flex flex-col gap-2.5 text-[15px] font-medium text-[#1D1B1A]/70 dark:text-foreground/60 pb-4 bg-[#FFFEF2] dark:bg-background">
        ...
        <main className="flex flex-col items-center">
          ...
          <section className="w-full px-6 pt-12 pb-12 flex flex-col items-center text-center">
            ...
            >Build your Portfolio.<br />Land 6X more Interviews.</motion.h1>
                ...
                <div key={i} className="flex flex-col gap-4">
                  {(item as any).messages ? (
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-[14px] font-medium text-[#1D1B1A]/45 dark:text-foreground/60">{item.sub}</p>
                    </div>
                  )}
                  {(item as any).cards ? (
          ...
          <section className="w-full border-t border-[#EAE9E4] dark:border-border pt-10 pb-10 overflow-hidden bg-[#F4F3E5] dark:bg-card">
            <div className="px-6 mb-6 text-center">
              ...
              <p className="mt-1.5 text-[14px] text-[#1D1B1A]/70 dark:text-foreground/60 font-medium">Over 1000+ portfolios are published every week.</p>
            </div>
            <PortfolioGallery />
          </section>
          ...
          <footer className="w-full border-t border-[#EAE9E4] dark:border-border">
            <div className="px-6 py-5 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[13px] font-medium text-[#1D1B1A]/70 dark:text-foreground/60 bg-[#F4F3E5] dark:bg-card">
        ...
        {showUploadModal && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setShowUploadModal(false)}
                className="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-[#1D1B1A]/[0.06] dark:bg-white/[0.08] text-[#1D1B1A]/70 dark:text-foreground/60 hover:bg-[#1D1B1A]/[0.12] dark:hover:bg-white/[0.14] hover:text-[#1D1B1A] dark:hover:text-foreground transition-all duration-150"
              >
                    ...
                    {[
                      ...
                      <div key={title} className="flex items-start gap-3.5">
                        ...
                        <div>
                          ...
                          <p className="text-[13px] text-[#1D1B1A]/70 dark:text-foreground/60 leading-relaxed">{desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
